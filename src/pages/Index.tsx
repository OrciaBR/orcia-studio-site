...
const Index = () => {
  return (
    <>
      <Seo
        title="Cubas Orcia - Beleza, design e elegância italiana"
        description="Cubas de design refinado, materiais nobres e acabamento impecável. Inspirada no Vale d'Orcia, Itália. Conheça a Orcia."
        canonical="https://orcia.com.br/"
      />
      {/* Skip link for accessibility */}
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only bg-primary text-primary-foreground p-2 absolute z-50"
      >
          ...
          <section className="relative h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 text-center text-primary-foreground max-w-4xl mx-auto px-6">
              ...
              <p className="font-inter text-lg md:text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
                Cubas com design refinado, materiais nobres e acabamento
                impecável. Inspirada no Vale d'Orcia, na Itália.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="border-primary-foreground text-primary hover:text-primary font-inter"
                >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div>
                  ...
                  <p className="font-inter text-lg text-muted-foreground mb-6 leading-relaxed">
                    Orcia nasce da inspiração no Vale d'Orcia, região da Toscana
                    conhecida pela beleza e requinte. Cada cuba é projetada com
                    atenção aos detalhes, traduzindo em suas formas a leveza da
                    água e a elegância da cerâmica.
                  </p>

                  <p className="font-inter text-lg text-muted-foreground mb-8 leading-relaxed">
                    O traço ondulado em nossa marca simboliza a fluidez da água
                    - elemento central do nosso produto, representando leveza,
            ...
            <div className="container mx-auto px-6">
              <div className="text-center mb-16">
                ...
                <p className="font-inter text-lg text-muted-foreground max-w-2xl mx-auto">
                  Cada detalhe pensado para elevar ambientes através da forma e
                  funcionalidade.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <Card className="border-0 shadow-lg">
                  <CardContent className="p-8 text-center">
                    ...
                    <p className="font-inter text-muted-foreground">
                      Formas elegantes inspiradas no design italiano, com linhas
                      que traduzem sofisticação e minimalismo.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-0 shadow-lg">
                  <CardContent className="p-8 text-center">
                    ...
                    <p className="font-inter text-muted-foreground">
                      Cerâmica de alta qualidade com acabamentos premium que
                      garantem durabilidade e beleza atemporal.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-0 shadow-lg">
                  <CardContent className="p-8 text-center">
                    ...
                    <p className="font-inter text-muted-foreground">
                      Cada peça é finalizada com cuidado artesanal, garantindo
          ...
          <section className="py-20 bg-primary">
            <div className="container mx-auto px-6 text-center">
              ...
              <p className="font-inter text-lg text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
                Descubra nossa linha completa de cubas e encontre a peça
